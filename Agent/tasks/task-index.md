...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **A-001** | Create project structure and core configurations | P0 | None | FastAPI application initialized with Ports & Adapters folder layout. PostgreSQL container running via Docker Compose. `/health` endpoint responding with 200 OK. | [ ] Pending |
| **A-002** | Define database schemas with SQLModel & Alembic | P0 | A-001 | Database models for `Cuenta`, `Persona`, and `Dispositivo` mapped with correct constraints. Alembic migrations generated and applied successfully in PostgreSQL database. | [ ] Pending |
